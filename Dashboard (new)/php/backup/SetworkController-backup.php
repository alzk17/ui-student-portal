            ...
            if($subject_id != null){
                ...
                if($subs){
                    ...
                    foreach($subs as $key=>$sub){
                        ...
                        $html.= '<div class="col-xl-2 col-4" style="width:20% !important;">
                            <input type="radio" class="btn-check subject-radio" name="subject_id" id="subject'.$sub->id.'" data-subject-id="'.$sub->id.'" value="'.$sub->id.'" '.$checked.' autocomplete="off">
                            <label class="btn btn-outline-checkbox" for="subject'.$sub->id.'">
                                <img src="'.Helper::getImage($sub->image).'" class="img-fluid icon-setwork" alt="">
                            '.$sub->name.'
                            </label>
                        </div>';
                    }
